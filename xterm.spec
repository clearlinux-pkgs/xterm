...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-394.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-394.tgz.asc
...
%setup -q -n xterm-394
cd %{_builddir}/xterm-394
pushd ..
cp -a xterm-394 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725332230
