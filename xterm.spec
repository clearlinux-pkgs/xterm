...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-398.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-398.tgz.asc
...
%setup -q -n xterm-398
cd %{_builddir}/xterm-398
pushd ..
cp -a xterm-398 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744484606
...
cp %{_builddir}/xterm-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xterm/061dc7f270949d0259c9b0be3b6792c3e7022a48 || :
cp %{_builddir}/xterm-%{version}/package/debian/copyright %{buildroot}/usr/share/package-licenses/xterm/d28f15556e3bb80a6318592cfde267276860d98d || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/share/package-licenses/xterm/061dc7f270949d0259c9b0be3b6792c3e7022a48
/usr/share/package-licenses/xterm/d28f15556e3bb80a6318592cfde267276860d98d
