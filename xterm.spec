...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-389.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-389.tgz.asc
...
%prep
%setup -q -n xterm-389
cd %{_builddir}/xterm-389
pushd ..
cp -a xterm-389 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704214513
