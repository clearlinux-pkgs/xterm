...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-397.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-397.tgz.asc
...
%setup -q -n xterm-397
cd %{_builddir}/xterm-397
pushd ..
cp -a xterm-397 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736177444
