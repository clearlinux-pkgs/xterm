...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-388.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-388.tgz.asc
...
%prep
%setup -q -n xterm-388
cd %{_builddir}/xterm-388
pushd ..
cp -a xterm-388 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698075599
