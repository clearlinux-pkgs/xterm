...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-396.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-396.tgz.asc
...
%setup -q -n xterm-396
cd %{_builddir}/xterm-396
pushd ..
cp -a xterm-396 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733326464
...
cp %{_builddir}/xterm-%{version}/package/debian/copyright %{buildroot}/usr/share/package-licenses/xterm/11634268352bc8aa7d25a958cc06a3ca15175450 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/share/package-licenses/xterm/11634268352bc8aa7d25a958cc06a3ca15175450
/usr/share/package-licenses/xterm/63905ef968d32e883631b0563d8dd1da81b1391b
