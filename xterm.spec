...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-393.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-393.tgz.asc
...
%setup -q -n xterm-393
cd %{_builddir}/xterm-393
pushd ..
cp -a xterm-393 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720803234
