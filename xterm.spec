...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-399.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-399.tgz.asc
...
%setup -q -n xterm-399
cd %{_builddir}/xterm-399
pushd ..
cp -a xterm-399 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747667621
