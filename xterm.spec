...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-387.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-387.tgz.asc
...
%prep
%setup -q -n xterm-387
cd %{_builddir}/xterm-387
pushd ..
cp -a xterm-387 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697480089
