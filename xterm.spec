...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-390.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-390.tgz.asc
...
%prep
%setup -q -n xterm-390
cd %{_builddir}/xterm-390
pushd ..
cp -a xterm-390 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708447148
