...
Source0  : https://invisible-mirror.net/archives/xterm/xterm-395.tgz
Source1  : https://invisible-mirror.net/archives/xterm/xterm-395.tgz.asc
...
%setup -q -n xterm-395
cd %{_builddir}/xterm-395
pushd ..
cp -a xterm-395 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729868162
